...
function writeCards(people, event){
    for(let person = 0; person < people.length; person++){
        const newArray = [
            `Thank you, ${people[0]}, for the wonderful surprise gift!`,
            `Thank you, ${people[1]}, for the wonderful surprise gift!`,
            `Thank you, ${people[2]}, for the wonderful surprise gift!`
        ]
        return newArray
    }
}
...
function countDown(array) {
    let i = 10; // the initialization moves OUTSIDE
    while (i >= 0) {
      console.log(i);
      i--;     // the iteration moves INSIDE and AFTER log
    }
    return array;
  }
  countDown(array)
